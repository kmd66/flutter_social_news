    ...
    return InkWell(
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: widget.checked == true? ObjectColor.shadowBackground(.2):
            widget._isHovered == true ?ObjectColor.shadowBackground(.1):Colors.transparent,
